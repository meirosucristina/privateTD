...
public class DistributedPhaseMonitor {
    ...
    /**
     * Updates the number of executions/test that must be executed by the agents running in
     * the cluster. This method is called during the work redistribution process.
     */
